                    ...
                    <div class="mx-3 py-3 row gx-5">
                        ...
                        <div class="col-4">
                            <div class="bg-body border ratio ratio-1x1">
                                ...
                                <img class="object-fit-contain p-2" src="../lesson_img/<?= $row["img"] ?>" alt="">
                            </div>
                            <!-- Start of Form -->
                            <form action="doAddList.php" method="post" enctype="multipart/form-data">
                                <!-- 上傳檔案 -->
                        ...
                        <div class="col-8 pe-2">
                            <table class="table table-striped-columns">
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-10 border-end p-1">
                                        <textarea class="form-control" placeholder="輸入內容..." name="info" style="resize:none;" rows="10"><?= $row["info"] ?>
                                    </textarea>
                                    </td>
                                </tr>
                            </table>
